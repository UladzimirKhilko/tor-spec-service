...
const TEMPLATES = [
  {
    ...
    fields: [
      ...
      { key: 'model',
        ...
        // Собираем марку из количества пластин и раскладки каналов —
        // это надёжнее, чем строка "Теплообменник Пластинчатый..." из
        // спецификации, которая на OCR часто искажается. Если данных для
        // сборки не хватает — используем то, что удалось распознать в тексте.
        ...
        notes: 'Собирается автоматически как ТОР-15М/13-<кол-во пластин>-1х(<раскладка каналов>) — проверьте совпадение с реальной маркой' },
